class PhaseOneController < ApplicationController
  ...
  post '/phase_1_saved/:id' do
    ...
    @array_of_unmade_tasks.each do |make_this_a_task|
      Task.find_or_create_by(project_id: @project.id, the_action_description: "#{make_this_a_task}", comment_or_measure: "you must change this to continue.", base_rank: 0.0)
    end
